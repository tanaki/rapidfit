...
Version courante (non taguée) : v1.5.4 — prête à tagger
Prochain tag prévu : v1.5.4 (fix auto-update repo privé — owner/repo + GH_TOKEN)
Pour publier : git push origin dev && git tag v1.5.4 && git push origin v1.5.4
```
