...
export function TrackingOverlay({ mode, onStop }: Props) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 50 }}>
      <button
        className="absolute top-2 left-1/2 -translate-x-1/2 pointer-events-auto flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-medium backdrop-blur-sm border transition-colors"
