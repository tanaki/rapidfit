...
export function PanePlayer({ label, isLiveMode, isPaused, time, duration, fps, onPlayPause, onSeek, onFramePrev, onFrameNext, cuePoints, onSeekToCue, reserveWhenLive }: Props) {
  if (isLiveMode) {
