...
export function AnnotationCanvas({
  ...
  const onMouseUp = useCallback((e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    if (tool === 'skeleton') {
      // Clic = squelette SIMPLE, toujours (fiable, instantané, toutes sources).
      // La détection auto de pose est une option séparée (bouton dédié).
      // Refs pour discipline/skeletonFacing courants (absents des deps du handler).
