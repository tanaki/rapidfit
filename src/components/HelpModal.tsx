              ...
              {api && (
                <>
                  <button
                    ...
                    className="text-[10px] ml-1 px-1.5 py-0.5 rounded bg-[#22223b] hover:bg-[#2d2d48] disabled:opacity-40 text-slate-400 hover:text-slate-200 transition-colors font-medium"
                  >
                  ...
                  {updateStatus === 'ready' && (
                    <button
                      ...
                      className="text-[10px] ml-1 px-1.5 py-0.5 rounded bg-indigo-600 hover:bg-indigo-500 text-white transition-colors font-medium animate-pulse"
                    >
